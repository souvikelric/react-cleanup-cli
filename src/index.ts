...
async function updateFile(pathOf: string, mainFile: string) {
...
async function cleanAppCss(filePath: string) {
...
async function removeImport(pathOf: string, stringToSearch: string) {
  try {
...
async function changeSiteTitle(
  pathOf: string,
...
async function removeSvgs(pathToFiles: string[]) {
